...
class _ManageLocationPageState extends State<ManageLocationPage> {
  ...
  //     const LatLng(17.3850, 78.4867); // Default position (Hyderabad)
  ...
  Widget build(BuildContext context) {
    ...
    //         subtitle:
    //             const Text('Plot no.209, Kavuri Hills, Madhapur, Telangana'),
    ...
    //           icon: Icon(Icons.add_location_alt, color: AppColors().blue),
